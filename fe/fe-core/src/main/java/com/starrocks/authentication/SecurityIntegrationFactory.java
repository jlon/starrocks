...
public class SecurityIntegrationFactory {
    private static final ImmutableSortedSet<String> SUPPORTED_AUTH_MECHANISM =
            ImmutableSortedSet.orderedBy(String.CASE_INSENSITIVE_ORDER)
                    ...
                    .add(PluginSecurityIntegrationSupport.SHIELD_SHARED_AUTH_TYPE)
                    .build();
    ...
    public static SecurityIntegration createSecurityIntegration(String name, Map<String, String> propertyMap) {
        ...
        } else if (PluginSecurityIntegrationSupport.isShieldSharedAuthType(type)) {
            securityIntegration = PluginSecurityIntegrationSupport.createShieldShared(name, propertyMap);
        }
